...
const Center = ({ onClick, disabled }) => {
  ...
  return (
    <button
      ...
      className={classnames("absolute left-1/2 -translate-x-1/2 translate-y-1/2 text-sm rounded-full flex items-center justify-center active:scale-95 outline-none")}
    >
